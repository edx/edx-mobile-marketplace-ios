...
public enum AnalyticsEvent: String {
    ...
    case courseOutlineAssignmentsTabClicked = "Course:Assignments Tab"
...
public enum EventBIValue: String {
    ...
    case courseOutlineAssignmentsTabClicked = "edx.bi.app.course.assignments_tab"
    ...
    case contentPageSectionClicked = "edx.bi.app.course.content.section.clicked"
    case contentPageShowCompletedSubsectionClicked = "edx.bi.app.course.content.show_completed_subsection.clicked"
    case progressTabClicked = "edx.bi.app.course.progress_tab.clicked"
