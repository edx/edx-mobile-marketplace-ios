...
public enum AnalyticsEvent: String {
    ...
    case learnPrimaryCourseCardClicked = "Learn:Primary Course Card Clicked"
    case learnSecondaryCourseCardClicked = "Learn:Secondary Course Card Clicked"
    case learnViewAllCoursesClicked = "Learn:View All Courses Clicked"
    case learnViewAllCardClicked = "Learn:View All Card Clicked"
    case myCoursesAllCoursesViewed = "MyCourses:All Courses Viewed"
    case myCoursesFilterClicked = "MyCourses:Filter Clicked"
    case myCoursesCourseCardClicked = "MyCourses:Course Card Clicked"
    ...
    case courseOutlineContentTabClicked = "Course:Content Tab"
    case courseOutlineVideosTabClicked = "Course:Videos Tab"
    case courseOutlineProgressTabClicked = "Course:Progress Tab"
    ...
    case plsBannerDismissed = "PLS:Banner Dismissed"
    ...
    case courseVideoClicked = "Course:Video Clicked"
    case courseHomeSectionSubsectionClicked = "Course Home:Section/Subsection Click"
    case courseAssignmentClicked = "Course:Assignment Clicked"
    case courseContentAllTabClicked = "Course:Content All Tab"
    case courseContentVideosTabClicked = "Course:Content Videos Tab"
    case courseContentAssignmentsTabClicked = "Course:Content Assignments Tab"
    ...
    case discussionFollowToggle = "Discussion:Post Follow Toggle"
...
public enum EventBIValue: String {
    ...
    case viewCourseClicked = "edx.bi.app.discovery.course_info"
    ...
    case mainDashboardCoursesClicked = "edx.bi.app.learn.my_courses"
    case mainDashboardProgramsClicked = "edx.bi.app.learn.my_programs"
    case learnPrimaryCourseCardClicked = "edx.bi.app.learn.primary_course.clicked"
    case learnSecondaryCourseCardClicked = "edx.bi.app.learn.secondary_course.clicked"
    case learnViewAllCoursesClicked = "edx.bi.app.learn.view_all_courses.clicked"
    case learnViewAllCardClicked = "edx.bi.app.learn.view_all_card.clicked"
    case myCoursesAllCoursesViewed = "edx.bi.app.my_courses.all_courses.viewed"
    case myCoursesFilterClicked = "edx.bi.app.my_courses.filter.clicked"
    case myCoursesCourseCardClicked = "edx.bi.app.my_courses.course_card.clicked"
    ...
    case plsBannerDismissed = "edx.bi.app.dates.pls_banner.dismissed"
    ...
    case courseOutlineProgressTabClicked = "edx.bi.app.course.progress_tab"
    ...
    case courseOutlineContentTabClicked = "edx.bi.app.course.content_tab"
    ...
    case courseHomeGradesViewProgressClicked = "edx.bi.app.course.home.grades.view_progress.clicked"
    case courseHomeViewAllContentClicked = "edx.bi.app.course.home.view_all_content.clicked"
    case courseHomeAssignmentClicked = "edx.bi.app.course.home.assignment.clicked"
    case courseHomeViewAllVideosClicked = "edx.bi.app.course.home.view_all_videos.clicked"
    case courseHomeViewAllAssignmentsClicked = "edx.bi.app.course.home.view_all_assignments.clicked"
    case contentPageShowCompletedSubsectionClicked = "edx.bi.app.course.content.show_completed_subsection.clicked"
    case courseHomeVideoClicked = "edx.bi.app.course.home.video.clicked"
    case courseVideoClicked = "edx.bi.app.course.video.clicked"
    case courseHomeSectionSubsectionClick = "edx.bi.app.course.home.section_subsection.clicked"
    case courseAssignmentClicked = "edx.bi.app.course.assignment.clicked"
    case courseContentAllTabClicked = "edx.bi.app.course.content.all_tab"
    case courseContentVideosTabClicked = "edx.bi.app.course.content.videos_tab"
    case courseContentAssignmentsTabClicked = "edx.bi.app.course.content.assignments_tab"
    ...
    case discussionPostCreated = "edx.bi.app.discussion.post.created"
    case discussionResponseAdded = "edx.bi.app.discussion.response.added"
    case discussionCommentAdded = "edx.bi.app.discussion.comment.added"
    case discussionFollowToggle = "edx.bi.app.discussion.follow.toggle"
    case discussionLikeToggle = "edx.bi.app.discussion.like.toggle"
    case discussionReportToggle = "edx.bi.app.discussion.report.toggle"
