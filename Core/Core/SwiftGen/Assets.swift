...
public enum CoreAssets {
  ...
  public static let assignmentsRedClock = ImageAsset(name: "assignments_red_clock")
  public static let assignmentsRepeat = ImageAsset(name: "assignments_repeat")
  ...
  public static let videoPlayButton = ImageAsset(name: "videoPlayButton")
