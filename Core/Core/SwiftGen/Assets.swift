...
public enum CoreAssets {
  ...
  public static let datesActive = ImageAsset(name: "dates_active")
  public static let datesInactive = ImageAsset(name: "dates_inactive")
  ...
  public static let downloadsActive = ImageAsset(name: "downloads_active")
  public static let downloadsInactive = ImageAsset(name: "downloads_inactive")
