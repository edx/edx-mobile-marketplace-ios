...
public struct Theme: Sendable {
    ...
    public struct Colors: Sendable {
        ...
        nonisolated(unsafe) public private(set) static var primerHeaderBG = primaryCardUpgradeBG
        nonisolated(unsafe) public private(set) static var primerHeaderButtonText = ThemeAssets.primerHeaderButtonText.swiftUIColor
        nonisolated(unsafe) public private(set) static var primerContentBG = textInputBackground
